...
for M = Mach_numbers
    ...
    % Plot Mach lines
    plot(V_mach(49:100), altitudes_km(49:100), '-', 'LineWidth', 1.5, 'Color', [0.4940, 0.1840, 0.5560]);
...
for V_EAS = EAS_values
    ...
    plot(V_TAS(1:49), altitudes_km(1:49), '-.', 'LineWidth', 1.5, 'Color', 'blue');
...
plot([V_stall(end), V_mach(end)], [h_max/1000, h_max/1000], 'k--', 'LineWidth', 2);
