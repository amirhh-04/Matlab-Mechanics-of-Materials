...
if customary_unit == "SI"
    unitData = struct('si', true, 'delta_t', '/C', 'length', 'm', 'delta_0', 'm', 'elas_ticity', 'Pa', 'ra', 'kN', 'load_applied', '/C', 'area', 'm²', 'stress', 'MPa', 'deformation', 'microm');
else
    unitData = struct('si', false, 'delta_t', '/F', 'length', 'in', 'delta_0', 'in', 'elas_ticity', 'psi', 'ra', 'kips', 'load_applied', '/F', 'area', 'in²', 'stress', 'ksi', 'deformation', 'in');
end
...
for c = 1:tElements
    ...
    data{c, 1} = struct('element', c, 'length', length, 'area', area, 'elas_ticity', elas_ticity, 'load_applied', load_applied);
